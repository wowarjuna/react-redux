...
import { Box, Button, Card, Checkbox, FormControlLabel, IconButton, InputAdornment, makeStyles, SvgIcon, Table, TableBody, TableCell, TableHead, TablePagination, TableRow, TextField } from '@material-ui/core';
import { ProductType } from '../../../../models/product-type';
import { availabilityOptions, categoryOptions, sortOptions } from '../../../../helpers/inputProductOptions';
import { applyFilters, applyPagination, getInventoryLabel, TableResultsHelpers } from './TableResultsHelpers';
import clsx from 'clsx';
import { Search as SearchIcon, Image as ImageIcon, Edit as EditIcon, ArrowRight as ArrowRightIcon } from 'react-feather'
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {paginatedProducts.map(product => {
                                ...
                                return (<TableRow hover key={product.id} selected={isProductSelected}>
                                    <TableCell padding="checkbox">
                                        <Checkbox
                                            ...
                                            value={isProductSelected}></Checkbox>
                                    </TableCell>
